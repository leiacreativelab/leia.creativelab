...
// On peut tout à fait importer des composants client (Header/Footer) :
  ...
  return (
    <main>
      ...
      <article className="container py-16">
        <Link href="/portfolio" className="text-sm opacity-80 hover:opacity-100">
          ← Retour au portfolio
        </Link>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <span className="text-xs border border-white/20 rounded-full px-2 py-1 bg-black/40">
            {item.tags.join(" · ")}
          </span>
          <span className="text-xs border border-white/20 rounded-full px-2 py-1 bg-black/40">
            {item.year}
        ...
        <div className="mt-10">
          <Link href="/contact?type=similar" className="btn">
